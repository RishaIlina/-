        ...
        <div className={`container ${styles.top__inner}`}>
          <div className={styles.top__content}>
            ...
            <picture className={styles.top__img}>
              ...
              <Image width={1073} height={693} className="top__img-l" src="/image/top-l.png" alt="ассортимент свечей" />
            </picture>
          </div>
        </div>
      </section>
      ...
      <div className="container section__inner">
        ...
        <ol className={` ${styles.steps__list} section__content_descr section__decor `}>
          <li className={` ${styles.steps__item} ${styles.steps__item__odd} `}>
            ...
            <Image src="/image/s1.jpg" alt="Процесс приготовления свечи" width={160} height={220} className={styles.steps__item_img} />
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__odd} `}>
            <p className={styles.steps__item_text}>Подготовка формы: выбор формы для свечи и подготовка ее к наполнению
              воском/
            </p>
            <Image src="/image/s2.jpg" alt="Подготовка формы" width={160} height={220} className={styles.steps__item_img} />
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__even} `}>
            <Image src="/image/s3.jpg" alt="Приготовление воска" width={160} height={220} className={styles.steps__item_img} />
            <p className={styles.steps__item_text}>Приготовление воска: расплавление соевого воска в плавильном устройстве до
              нужной температуры.
            </p>
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__even} `}>
            <Image src="/image/s4.jpg" alt="Добавление красителей"  width={160} height={220} className={styles.steps__item_img} />
          ...
          <li className={` ${styles.steps__item} ${styles.steps__item__odd} `}>
            ...
            <Image src="/image/s5.jpg" alt="Процесс приготовления свечи" width={160} height={220} className={styles.steps__item_img} />
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__odd} `}>
            <p className={styles.steps__item_text}>После наполнения формы, нужно оставить свечи остывать и застывать.</p>
            <Image src="/image/s6.jpg" alt="Свеча" width={160} height={220} className={styles.steps__item_img} />
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__even} `}>
            <Image src="/image/s7.jpg" alt="Обрезка фитиля"  width={160} height={220} className={styles.steps__item_img} />
            <p className="steps__item-text">Обрезка фитиля и украшение: после застывания свечи, обрезаем фитиль до желаемой
              длины.
            </p>
          </li>
          <li className={` ${styles.steps__item} ${styles.steps__item__even} `}>
            <Image src="/image/s8.jpg" alt="Подарок"  width={160} height={220} className={styles.steps__item_img} />
